...
const Hero: React.FunctionComponent = () => {
    ...
    return (
        <section className={styles.heroContainer}>
            ...
            <h1 className={styles.heroText}>React & Next.js <br/> Developer</h1>
            <p className={styles.heroDesc}>Frontend Developer crafting scalable, user-focused web interfaces. <br/>Passionate about clean, reusable code and delivering high-quality, <br/>seamless digital experiences across modern React ecosystems.</p>
